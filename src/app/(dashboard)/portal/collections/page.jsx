    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex justify-between items-end border-b border-border/50 pb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-2">
            Manage and curate your thematic article collections.
          </p>
        </div>
        <Button
          as={Link}
          href="/portal/collections/edit/new"
          size="md"
          radius="full"
      ...
      {loading ? (
        <div className="py-32 flex flex-col items-center justify-center gap-4">
          ...
          <p className="text-xs uppercase tracking-widest font-bold text-muted-foreground animate-pulse">
            Loading Collections
          </p>
        </div>
        ...
        <div className="py-24 flex flex-col items-center justify-center text-center border border-dashed border-border rounded-2xl bg-card">
          ...
          <p className="text-muted-foreground text-sm max-w-sm mb-6">
            Group your articles into cohesive collections to keep your readers
            engaged.
          </p>
          <Button
            variant="bordered"
            className="border-border uppercase font-bold text-xs tracking-widest"
          >
